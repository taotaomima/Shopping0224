package com.gtt.shoppingstoreback.util;
...
import com.gtt.shoppingstoreback.vo.CustomerLoginVO;
...
public class JWTUtil {
    ...
    public CustomerLoginOut issueToken(Customer customer) {
        Date now = new Date();
        ...
        CustomerLoginOut customerLoginOutDTO = new CustomerLoginOut();
